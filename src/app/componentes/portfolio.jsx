    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white p-4 shadow-md rounded-lg z-10">
                ...
                <button
                    onClick={onClose}
                    className="mt-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 absolute top-0 right-2"
                >
                    Cerrar
                </button>
            </div>
        ...
        <div className="pt-6 pb-6 text-gray-900 text-center" id='Portfolio'>
            ...
            {modalOpen && (
                ...
                <div className="flex flex-wrap mt-6 p-4">
                    <div
                        onClick={() => handleImageClick('/tufic/tufic1.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/tufic/tufic1.jpg"
                            alt="Imagen 1"
                    ...
                    <div
                        onClick={() => handleImageClick('/tufic/tufic2.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/tufic/tufic2.jpg"
                            alt="Imagen 2"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
                    ...
                    <div
                        onClick={() => handleImageClick('/tufic/tufic3.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/tufic/tufic3.jpg"
                            alt="Imagen 2"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
                    ...
                    <div
                        onClick={() => handleImageClick('/tufic/tufic4.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/tufic/tufic4.jpg"
                            alt="Imagen 2"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
            ...
            <section>
                ...
                <div className="flex flex-wrap mt-6 p-4">
                    <div
                        onClick={() => handleImageClick('/mottos/mottos1.jpg')}
                        className="w-4/4 lg:w-1/3 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/mottos/mottos1.jpg"
                            alt="Imagen 1"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
                    ...
                    <div
                        onClick={() => handleImageClick('/mottos/mottos2.jpg')}
                        className="w-4/4 lg:w-1/3 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/mottos/mottos2.jpg"
                            alt="Imagen 2"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
                    ...
                    <div
                        onClick={() => handleImageClick('/mottos/mottos3.jpg')}
                        className="w-4/4 lg:w-1/3 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/mottos/mottos3.jpg"
                            alt="Imagen 2"
                            className="w-full h-auto rounded-md"
                            width={500}
                            height={500}
            ...
            <section>
                ...
                <div className="flex flex-wrap mt-6 p-4">
                    <div
                        onClick={() => handleImageClick('/adai/adai1.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/adai/adai1.jpg"
                    ...
                    <div
                        onClick={() => handleImageClick('/adai/adai2.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/adai/adai2.jpg"
                    ...
                    <div
                        onClick={() => handleImageClick('/adai/adai3.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/adai/adai3.jpg"
                    ...
                    <div
                        onClick={() => handleImageClick('/adai/adai4.jpg')}
                        className="w-4/4 lg:w-1/4 p-2 cursor-pointer justify-center"
                    >
                        <Image
                            src="/adai/adai4.jpg"
