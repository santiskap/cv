...
export default function DropdrownHandler() {
                    ...
                    <div className="mx-auto container px-6 py-2 xl:py-0">
                        <div className="flex items-center justify-between">
                                        ...
                                        <ul className="p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
                                            <li className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-2 font-bold">Santiago Tula</span>
                                                </div>
                                            </li>
                            ...
                            <div className="flex w-full sm:w-auto items-center sm:items-stretch justify-end sm:justify-start">
                                <div className="flex items-center">
                                    <Image src="/logo.jpg" alt="Santiago Tula - Front-end Developer" width="40" height="40"></Image>
                                    <h2 className="hidden sm:block text-base text-gray-700 font-bold leading-normal pl-3">Santiago Tula</h2>
                                </div>
                            </div>
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-0 xl:mr-0">
                ...
                <nav>
                    <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white fixed top-0 z-40">
                        <div className="w-24">
                            ...
                            {/*    />*/}
                            {/*</svg>*/}
                            <Image src="/logo.jpg" alt="Santiago Tula" width="80" height="80"></Image>
                                        ...
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    {/*</svg>*/}
                                                    <Image src="/logo.jpg" alt="Santiago Tula - Front-end Developer" width="40" height="40"></Image>
                                                    <p className="text-base md:text-2xl text-gray-800 ml-3">Santiago Tula</p>
                                                </div>
                                        ...
                                        <ul className="f-m-m">
                                            <a className="cursor-pointer" href="./">
                                                <li className="text-gray-800 pt-10">
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 md:w-8 md:h-8 text-blue-500">
                                                        ...
                                                        <p className="text-blue-500 xl:text-base md:text-lg text-base ml-3">Inicio</p>
                                                    </div>
                                                </li>
                                            </a>
                                                ...
                                                <li className="text-gray-800 pt-8">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="text-gray-800 xl:text-base md:text-lg text-base ml-3">Portfolio</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </a>
